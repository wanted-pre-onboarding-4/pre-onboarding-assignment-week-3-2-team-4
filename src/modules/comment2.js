...
export const postComments = createPromiseThunk(POST_COMMENT, commentApi.post);
export const deleteComments = createPromiseThunk(
  DELETE_COMMENT,
  commentApi.delte
);
export const putComments = createPromiseThunk(PUT_COMMENT, commentApi.put);
